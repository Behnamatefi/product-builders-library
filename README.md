...
Bilingual (English / فارسی) interactive **knowledge-graph** summaries of **60 essential books for product builders**, organized into **18 skill groups** — based on Lenny Rachitsky's two-part *"Essential books for product builders"* reading list.

‏کتابخانه‌ای دوزبانه از خلاصهٔ ۶۰ کتابِ ضروری برای سازندگانِ محصول، در قالبِ نقشهٔ دانشِ تعاملی — ساده، خواندنی، و برای یادگیری.‏
...
builds a **sorted reading flow** from the 60 books. On desktop it's a modal; on mobile
it's a bottom sheet.
